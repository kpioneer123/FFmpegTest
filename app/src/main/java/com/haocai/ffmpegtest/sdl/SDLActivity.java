package com.haocai.ffmpegtest.sdl;
...
public class SDLActivity extends Activity {
    ...
    public static void initialize() {
        ...
        // Otherwise, when exiting the org.libsdl.app and returning to it, these variables *keep* their pre exit values
        mSingleton = null;
        mSurface = null;
        mTextEdit = null;
        mLayout = null;
    ...
    protected void onDestroy() {
        ...
        if (SDLActivity.mBrokenLibraries) {
           super.onDestroy();
           // Reset everything in case the user re opens the org.libsdl.app
    ...
    public static void handleNativeState() {
        ...
        if (mNextNativeState == NativeState.RESUMED) {
            if (mIsSurfaceReady && mHasFocus && mIsResumedCalled) {
                if (mSDLThread == null) {
                    // This is the entry point to the C org.libsdl.app.
                    // Start up the C org.libsdl.app thread and enable sensor input for the first time
